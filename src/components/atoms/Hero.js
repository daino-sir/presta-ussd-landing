...
function Hero() {
  return (
    <div className='flex flex-col md:flex-row items-center content-center justify-center h-screen w-full bg-white'>
        ...
        <p className='text-lg font-black md:text-xl text-blue-600 text-center md:text-left'>Guarantee loans Anywhere and Anytime</p>
        <div className='flex flex-col w-full items-center md:flex-row'>
          <button className='w-52 font-black md:w-36 rounded-md button text-current'>Sign In</button>
          <button className='w-52 font-black md:w-36 my-2 md:mx-2 rounded-md button text-current'>Sign Up</button>
        </div>
        </div>
